    ...
    <div class="navbar-section">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-dark">
                <router-link class="navbar-brand" :to="{name: 'home'}" exact data-target=".show" data-toggle="collapse"> <i class="fa fa-sticky-note fa-fw"></i> A-Bot</router-link>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li v-if="!user" class="nav-item">
                            <router-link :to="{name: 'markets'}" data-target=".show" data-toggle="collapse" class="nav-link">Markets</router-link>
                        </li>
